        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline mb-4">
                <div class="card-header">
                    <div class="card-title">Form Tambah Produk Baru</div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="QuantityPerUnit" name="QuantityPerUnit" placeholder="e.g., 24 - 12 oz bottles">
                            </div>
                        </div>
                                ...
                                <select name="SupplierID" id="SupplierID" class="form-select">
                                    <option value="">Pilih Supplier...</option>
                                     <?php foreach ($suppliers as $supplier): ?>
                                        <option value="<?php echo $supplier['SupplierID']; ?>"><?php echo htmlspecialchars($supplier['CompanyName']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="UnitPrice" name="UnitPrice" step="0.01" value="0">
                            </div>
                            <div class="col-md-4">
                                <label for="UnitsInStock" class="form-label">Units In Stock</label>
                                <input type="number" class="form-control" id="UnitsInStock" name="UnitsInStock" value="0">
                            </div>
                            <div class="col-md-4">
                                <label for="ReorderLevel" class="form-label">Reorder Level</label>
                                <input type="number" class="form-control" id="ReorderLevel" name="ReorderLevel" value="0">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="UnitsOnOrder" name="UnitsOnOrder" value="0">
                            </div>
                            <div class="col-md-8 pt-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="Discontinued" name="Discontinued">
